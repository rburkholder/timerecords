...
${OBJECTDIR}/AppManager.o: AppManager.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AppManager.o AppManager.cpp

${OBJECTDIR}/AppTimeRecords.o: AppTimeRecords.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AppTimeRecords.o AppTimeRecords.cpp
...
${OBJECTDIR}/model/AccountTaskType.o: model/AccountTaskType.cpp
	${MKDIR} -p ${OBJECTDIR}/model
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/model/AccountTaskType.o model/AccountTaskType.cpp
...
${OBJECTDIR}/model/CompanyTaskType.o: model/CompanyTaskType.cpp
	${MKDIR} -p ${OBJECTDIR}/model
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/model/CompanyTaskType.o model/CompanyTaskType.cpp

${OBJECTDIR}/model/DbVersion.o: model/DbVersion.cpp
	${MKDIR} -p ${OBJECTDIR}/model
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/model/DbVersion.o model/DbVersion.cpp
